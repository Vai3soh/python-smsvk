...
class GetBalance(Api):
    ...
    def request(self):
        ...
        return self.get_request_to_api(f"{url_}{self.api_key}{action}",inspect.stack()[0][3],self.__class__.__name__)
...
class GetAvaibleService(Api):
    ...
    def request_json(self):
        ...
        return self.get_request_to_api(url,inspect.stack()[0][3],self.__class__.__name__)
...
class SetStatusActivation(Api):
    ...
    def request_(self, id_: List[Tuple]):
        ...
        return self.get_request_to_api(url,inspect.stack()[0][3],self.__class__.__name__,id_)
